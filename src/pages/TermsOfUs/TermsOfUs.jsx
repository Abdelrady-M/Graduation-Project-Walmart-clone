...
export default function TermsOfUs(){
    ...
    <div className="pt-4 ml-52">
        ...
        <a href="#" className="text-xs hover:underline"> Terms Of Us</a> / 
        <a href="#" className="text-xs hover:underline"> Walmart.com Terms Of Us</a>
    </div>
    ...
    <div className="container flex justify-center p-4 ">
        <div className= " md:pl-48 md:w-1/3">
            <h1 className="my-3 font-semibold">Help Topics</h1>
            <hr />
            <div className="grid grid-cols-1 mt-4 space-y-5">
                <a href="#" className="text-xs hover:underline">Your Order</a>
                <a href="#" className="text-xs hover:underline">Account & Payments</a>
                <a href="#" className="text-xs hover:underline">Returns & Refunds</a>
                <a href="#" className="text-xs hover:underline">Walmart Services</a>
                <a href="#" className="text-xs hover:underline">Walmart+</a>
                <a href="#" className="text-xs hover:underline">Shopping with Walmart</a>
                <a href="#" className="text-xs hover:underline">Terms of Use</a>
                <a href="#" className="text-xs hover:underline">Policies</a>
            </div>
            <div className="my-4">
        ...
        <div className="w-[70%] text-sm md:w-[80%] pl-14 pr-28 " style={{textAlign:"justify"}}>
            ...
            <p className="my-3">IMPORTANT: THESE TERMS OF USE CONTAIN A MANDATORY ARBITRATION PROVISION THAT, AS FURTHER SET FORTH IN SECTION 20 BELOW, REQUIRES THE USE OF ARBITRATION ON AN INDIVIDUAL BASIS TO RESOLVE DISPUTES. THIS MEANS THAT YOU AND WALMART ARE EACH GIVING UP THE RIGHT TO SUE EACH OTHER IN COURT OR IN CLASS ACTIONS OF ANY KIND. IN ARBITRATION, THERE IS NO JUDGE OR JURY AND THERE IS LESS DISCOVERY AND APPELLATE REVIEW THAN IN COURT.</p>
            <h1 className="text-xl font-bold ">1. Introduction</h1>
            <p className="my-3">Welcome to the family of websites and applications provided by Walmart. These Terms of Use govern your access to and use of all Walmart Sites among other things. By using the Walmart Sites, you affirm that you are of legal age to enter into these Terms of Use, or, if you are not, that you have obtained parental or guardian consent to enter into these Terms of Use and your parent or guardian consents to these Terms of Use on your behalf. If you violate or do not agree to these Terms of Use, then your access to and use of the Walmart Sites is unauthorized. Additional terms and conditions apply to some services offered on the Walmart Sites (e.g., Walmart Pharmacy, Walmart +, and Gift Cards) or through other channels. Those terms and conditions can be found where the relevant service is offered on the Walmart Sites or otherwise and are incorporated into these Terms of Use by reference.</p>
            <h1 className="text-xl font-bold ">DEFINED TERMS:</h1>
            <p>In these Terms of Use:</p>
            <p>When we say “Walmart,” we mean Wal-Mart.com USA, LLC and Walmart Inc., and any subsidiaries of Wal-Mart Stores, Inc. (including any subsidiaries that Walmart Inc. may form or acquire in the future), and their affiliates, directors, officers, employees and agents. We also refer to Walmart as “we,” “us” and “our.” But when we say “Walmart Entities,” we mean Walmart; its suppliers, vendors, contractors, and licensors.
...
When we say “Walmart Apps,” we mean the official “Walmart App” for iPhone and Android, which can be downloaded from the iTunes App Store or the Google Play Store.
When we say “you” or “your” we mean any user (like you!) of any Walmart Site and any person who has notice of these Terms of Use.
When we say “Terms of Use,” we mean these Terms of Use and all other terms and policies posted by Walmart on the Walmart Sites (and any updates by Walmart to these Terms of Use and those terms and policies).
...
When we say “Ideas,” we mean ideas, concepts, feedback, and know-how that you make available in connection with the Walmart Sites.
When we say “make available,” we mean post, transit, publish, upload, distribute, transmit, display, provide, or otherwise submit or make available (including through any part of the Walmart Sites administrated by third-party social media platforms (e.g., Facebook or Instagram) that allow interaction with the Walmart Sites through the tools offered by such social media platforms).
When we say “Materials,” we mean Content that Walmart Entities make available on or through the Walmart Sites, including In Store Now information.
WARRANTY DISCLAIMERS AND LIABILITY LIMITATIONS: While there are important points throughout these Terms of Use, please note the warranty disclaimers and limitations on Walmart’s liability explained in Sections 17 and 18, respectively.

UPDATES: We may update these Terms of Use from time to time by notifying you of such changes by any reasonable means, including by posting a revised Terms of Use through the Walmart Sites. Any such changes will not apply to any dispute between you and us arising prior to the date on which we posted the revised Terms of Use incorporating such changes or otherwise notified you of such changes. You agree that it your responsibility to regularly check Walmart.com for any updated Terms of Use. In addition, by continuing to use or access any of the Walmart Sites or otherwise engaging with Walmart after we post any changes, you accept the updated Terms of Use. The “Last Updated” legend above indicates when these Terms of Use were last changed.</p>
<h1 className="my-3 text-xl font-bold ">2. Your Use of the Walmart Sites</h1>
...
Make available any Content through or in connection with the Walmart Sites that is or may be in violation of the content guidelines set forth in Section 3.C (Prohibited Content) below.
Make available through or in connection with the Walmart Sites any virus, worm, Trojan horse, Easter egg, time bomb, spyware, or other computer code, file or program that is or is potentially harmful or invasive or intended to damage or hijack the operation of, or to monitor the use of, any hardware, software, or equipment.
Use the Walmart Sites for any commercial purpose, or for any purpose that is fraudulent or otherwise tortious or unlawful.
Harvest or collect information about users of the Walmart Sites.
Interfere with or disrupt the operation of the Walmart Sites or the systems, servers, or networks used to make the Walmart Sites available, including by hacking or defacing any portion of the Walmart Sites; or violate any requirement, procedure or policy of such servers or networks.
Restrict or inhibit any other person from using the Walmart Sites.
Reproduce, modify, adapt, translate, create derivative works of, sell, rent, lease, loan, timeshare, distribute, or otherwise exploit any portion of (or any use of) the Walmart Sites except as expressly authorized in these Terms of Use, without Walmart’s express prior written consent.
Reverse engineer, decompile, or disassemble any portion of the Walmart Sites, except where such restriction is expressly prohibited by applicable law.
Remove any copyright, trademark, or other proprietary rights notice from the Walmart Sites.
Frame or mirror any portion of the Walmart Sites, or otherwise incorporate any portion of the Walmart Sites into any product or service, unless you obtain Walmart’s express prior written consent to do so.
...
You will not attempt to do anything, or permit, encourage, assist, or allow any third party to do anything, prohibited in this Section, or attempt, permit, encourage, assist, or allow any other violation of these Terms of Use.</p>
<h1 className="text-xl font-bold ">3. Content and Ideas</h1>
<h1 className="text-sm font-bold ">A. Submitting Content and Ideas</h1>
<p>Walmart provides functionality that enables users to make available Content and Ideas in connection with the Walmart Sites. Any text in Content should be written in English. You acknowledge and agree that you are responsible for all Content and Ideas you make available in connection with any Walmart Site. You represent and warrant that (1) you have the authority to grant the rights in such Content and Ideas as set forth in these Terms of Use, including in Section 3(B) below; and (2) such Content and Ideas, and the use of such Content and Ideas, will not violate any term of these Terms of Use. This means you will be responsible for the legality, the accuracy, the appropriateness, the originality, and your rights in any such Content and Ideas.</p>
<h1 className="text-xl font-bold ">B. Walmart’s Rights to Use Content and Ideas</h1>
<p>You grant to Walmart a royalty-free, perpetual, irrevocable, worldwide, unlimited, nonexclusive license to use, reproduce, create derivative works from, modify, publish, edit, translate, distribute, perform and display (publicly or otherwise) any Content that you make available, in any media or medium, and in any form, format, or forum now known or hereafter developed. You further agree that Walmart is free to use any Ideas for any purpose. Walmart may sublicense its rights in Content and Ideas through multiple tiers of sublicenses. Walmart is, and will be, under no obligation (1) to maintain any Content or Idea in confidence; (2) to pay any compensation for any Content or Idea; or (3) to respond to any Content or Idea. You grant to Walmart the right to use any name associated with any Content or Idea that you make available to Walmart, although Walmart has no obligation to exercise such right, or to otherwise provide any attribution for any Content or Idea.</p>

<h1 className="text-xl font-bold ">C. Prohibited Content</h1>
<p>You agree that you will not make available Content in connection with the Walmart Sites that:
...
is intended to cause harm, damage, disable, or otherwise interfere with the Walmart Sites or our partners.</p>

<h1 className="text-xl font-bold ">4. Monitoring by Walmart</h1>
<p>Walmart will have the right (but not the obligation), in our sole discretion, to monitor, evaluate, and analyze Content, and any use of and access to the Walmart Sites, including to determine compliance with these Terms of Use and any other operating rules that may be established by Walmart from time to time. Walmart will also have the right (but not the obligation), in our sole discretion, to edit, move, delete, or refuse to make available any Content made available through, the Walmart Sites, for any reason, including violation of these Terms of Use, whether for legal or other reasons. Despite this right of ours, you are solely responsible for any Content you make available, and you agree to indemnify Walmart for all claims resulting from any Content you make available.</p>

<h1 className="text-xl font-bold ">5. Materials Available on the Walmart Sites</h1>
<p>Walmart and its suppliers and licensors may make available various Materials. The Materials are for educational and informational purposes only, and errors may appear from time to time. Before you act in reliance on any Materials, you should confirm any facts that are important to your decision. The Walmart Entities make no warranty as to the reliability, accuracy, timeliness, usefulness, or completeness of any Materials. If you find an error or notice something that does not look quite right on the Walmart Sites, we would appreciate it if you let us know by contacting us at http://www.walmart.com/help (Your feedback is a big part of what helps Walmart to get better at helping you!) NO MATERIALS RELATED TO HEALTH, WELLNESS, PRESCRIPTIONS, OR PHARMACEUTICALS ARE INTENDED TO SUBSTITUTE FOR THE DIAGNOSIS, TREATMENT AND ADVICE OF A MEDICAL PROFESSIONAL, AND SUCH MATERIALS DO NOT COVER ALL POSSIBLE USES, PRECAUTIONS, SIDE EFFECTS, AND INTERACTIONS, AND SHOULD NOT BE CONSTRUED TO INDICATE THAT ANY DRUG IS SAFE OR EFFECTIVE FOR YOU. CONSULT THE PRODUCT INFORMATION (INCLUDING PACKAGE INSERTS) REGARDING DOSAGE, PRECAUTIONS, WARNINGS, AND INTERACTIONS, AND YOUR MEDICAL PROFESSIONAL, FOR GUIDANCE BEFORE USING ANY PRESCRIPTION OR OVER-THE-COUNTER DRUG.

THE WALMART ENTITIES ASSUME NO RESPONSIBILITY FOR ANY CONSEQUENCE RELATING DIRECTLY OR INDIRECTLY TO ANY ACTION OR INACTION YOU TAKE BASED ON THE MATERIALS.</p>

<h1 className="text-xl font-bold ">6. Merchandise</h1>
<p>The Sites may make available listings, descriptions, and images of goods and services (collectively, “Products”). Such Products may be made available by us or by third parties. We make no representations as to the completeness, accuracy, reliability, validity, or timeliness of such listings, descriptions, or images (including any features, specifications, and prices contained on the Sites). Such information and the availability of any Product are subject to change at any time without notice.
