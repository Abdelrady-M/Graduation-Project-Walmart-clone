                                        ...
                                        <div className='flex flex-col justify-center'>
                                            <div>
                                                ...
                                                <div className='flex items-start justify-between'>
                                                    <div>
                                                        <div className='flex items-center '>
                                                            <img className="mr-4" src='https://i5.walmartimages.com/seo/Restored-Apple-MacBook-Pro-Core-i5-2-3GHz-8GB-RAM-256GB-SSD-13-Space-Gray-MPXT2LL-A-2017-Refurbished_36413ec2-70d8-4ff0-bf5e-9cdd81422f6f_1.076884088c451e82b6467f6fca5b264d.jpeg?odnHeight=96&odnWidth=96&odnBg=FFFFFF' />
                                                            <div className='flex flex-col'>
                                                                <div >
                                                                    <h1 className='w-[417px]'>Restored Apple MacBook Pro Core i5 2.3GHz 8GB RAM 256GB SSD 13" Space Gray MPXT2LL/A 2017 (Refurbished)</h1>
                                                                </div>
                                                                <div className='flex flex-col'>
                                                    ...
                                                    <div className='flex items-start'>
                                                        <span className='font-bold text-[18px]'>$326.00</span>
                                                    </div>
                                                </div>
                                            ...
                                            <div className='flex justify-end items-center'>
                                                <div>
                                                    <a className='underline mr-5 cursor-pointer'>Remove</a>
                                                </div>
                                                <div>
                                                    <a className='underline mr-5 cursor-pointer'>Save for later</a>
                                                </div>
                                                <div>
                                                    <span className='flex items-center justify-between border border-black w-[120px] h-[34px] rounded-full p-5'>
                                                        <a href='#'><GoPlus className='w-[25px] h-[25px] rounded-full z-50 hover:bg-stone-500' /></a>
                                                        <sapn className='px-3 text-[14px] font-bold'>1</sapn>
                                                        <a href='#' ><HiMinus className='w-[25px] h-[25px] rounded-full z-50 hover:bg-stone-500' /></a>
                                                    </span>
                                                </div>
                                            </div>
                                        </div>
