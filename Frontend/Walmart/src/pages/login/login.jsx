      ...
      <div className="MainLogin">
        <div className="contentLog container mx-auto flex flex-col justify-center items-center py-6 ">
          ...
          <div className="flex flex-col mb-5">
            <h1 className="font-medium text-[20px] mb-5 flex text-center items-center justify-center">
          ...
          >
            ...
            />
            {errors.email && (
              <p className="text-red-500 ps-4">{errors.email.message}</p>
            )}

            <FormControl
              sx={{ marginTop: "10px", width: "472px" }}
              variant="outlined"
              id="outlined-basic"
            >
            ...
            {errors.password && (
              <p className="text-red-500 ps-4">{errors.password.message}</p>
            )}
            <button
              type="submit"
