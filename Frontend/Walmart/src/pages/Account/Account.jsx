      ...
      <div className="container mx-auto flex px-10 lg:flex-row">
        ...
        <div className="rightAccount py-16 pl-5 w-[90%] ">
          <div className="grid md:grid-cols-2 items-center justify-between w-[100%]">
            <div>
              <h1 className="flex items-center text-[32px] font-semibold text-[#2e2f32]">
            ...
            <div>
              <h1 className="flex items-center text-[24px] text-[#002d58] font-semibold">
                ...
                />
                $0 Walmart Cash{" "}
                <span className="underline text-[16px] ml-3 text-black">
                  How to get more
                </span>
              </h1>
            </div>
          ...
          <div className="flex justify-between py-5 px-5 rounded bg-[#f2f8fd] shadowAcc mt-10 cursor-pointer w-[100%]">
            <div>
              <h1 className="flex items-center text-[20px] font-medium">
                <IoReceiptOutline className="mr-5 text-[20px]" />
                Purchase history
              </h1>
            </div>
            ...
            <div className="flex justify-between ">
              <div>
                <h1 className="flex items-center text-[20px] font-semibold">
                  <PaymentIcon className="mr-5 text-[20px]" />
                  Wallet{" "}
                  <span className="text-[20px] ml-3">| Payment methods </span>
                </h1>
              </div>
            ...
            <div className="flex flex-wrap mt-5 ">
              <div className="flex flex-col items-center justify-center py-5 px-10 shadowBtn bg-white rounded-md mr-5 w-[192px] mb-5">
                <img
                  ...
                  className="mb-3"
                />
                <span className="text-[#2e2f32] text-[14px] font-semibold">
                  Credit/debit card
                </span>
              </div>
              ...
              <div className="flex flex-col items-center justify-center py-5 px-10 shadowBtn bg-white rounded-md mr-5 w-[190px] mb-5">
                <img
                  ...
                  className="mb-3 w-[70px]"
                />
                <span className=" flex text-center text-[#2e2f32] text-[14px] font-semibold">
          ...
          <div className="mt-10 rounded shadowAcc">
            ...
            <div className="flex flex-wrap ">
              ...
              <div className="flex flex-col p-5 border-b w-[460px] border-gray">
                ...
                <span className="underline text-[14px] cursor-pointer">
                  Add phone number
                </span>
              </div>
              <div className="flex items-center justify-between w-full p-5 border-t border-gray">
                ...
                <div>
                  <button className="bg-inherit text-[12px] font-bold p-1 rounded-full flex text-center justify-center items-center gap-1 border border-black-800 w-[127px] h-[32px] hover:border-2 border-black ">
                    Add an address
                  </button>
                </div>

                <div>
                  <h1 className="text-[18px] font-semibold">address1:</h1>
                  <h3 className="text-[14px]">
                    <span>newQena street</span>
                    <span>Qena city</span>
                    <span>,postal code 11122233</span>
                  </h3>
                </div>
              </div>
            </div>
          ...
          <div className="mt-10 rounded shadowAcc">
            <div className="flex justify-between py-5 px-5 rounded bg-[#f2f8fd]  mt-10 cursor-pointer">
              <div>
                <h1 className="flex items-center text-[20px] font-medium">
                  <CiHeart className="mr-5 text-[28px]" />
                  Lists (2)
                </h1>
              </div>
              <div className="flex items-center">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center px-10">
                <div>
                  <img
                    src="https://i5.walmartimages.com/seo/Lenovo-Legion-Pro-5-16IRX8-16-0-165-Hz-IPS-Intel-Core-i7-13th-Gen-13700HX-2-10GHz-GeForce-RTX-4060-Laptop-GPU-16-GB-DDR5-1-TB-PCIe-SSD-Windows-11-Hom_3d446919-be1c-474c-b3c5-7d92ce704505.51b2e610aa84142bd421437e8a1af438.jpeg"
                    className="w-[48px]"
                  />
                </div>
              ...
              <div className="flex p-5">
                <Link to={"/wishlist"}>
                  <button className="bg-inherit text-[12px] font-bold p-1 rounded-full flex text-center justify-center items-center gap-1 border border-black-800 w-[80px] h-[32px] hover:border-2 border-black ">
                    View list
                  </button>
                </Link>
              </div>
          ...
          <div className="grid grid-cols-1 mt-10 md:space-x-5 space-y-14 md:space-y-0 md:grid-cols-2">
            <div className="shadowAcc w-[100%] rounded-md mr-5">
              <div className="flex py-5 px-5 rounded bg-[#f2f8fd] cursor-pointer">
                <div>
                  <h1 className="flex items-center text-[20px] font-medium">
                    <MdOutlineLocalConvenienceStore className="mr-5 text-[28px]" />
              ...
              <div className="flex justify-between p-5 w-[100%]">
                <div className="flex flex-col items-center justify-between">
                  ...
                  <button className="bg-inherit text-[12px] font-bold p-1 rounded-full flex text-center justify-center items-center gap-1 border border-black-800 w-[150px] h-[32px] hover:border-2 border-black ">
                    Update store
                  </button>
                </div>
                <div>
            ...
            <div className="shadowAcc">
              <div className=" w-[100%] rounded-md flex flex-col">
                <div className="flex py-5 px-5 rounded bg-[#f2f8fd] cursor-pointer">
                  <div>
                    <h1 className="flex items-center text-[20px] font-medium">
                      <GrServices className="mr-5 text-[28px]" />
