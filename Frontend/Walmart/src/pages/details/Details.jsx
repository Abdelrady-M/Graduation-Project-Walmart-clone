                    ...
                    <div className='leftSide fixed top-0 right-36 md:relative md:right-auto container mx-auto hidden md:flex flex-col justify-center lg:w-[500px] border border-[#b7b7b7] rounded p-5'>
                        ...
                        <div>
                            <div className='productTitle text-[20px] font-medium mt-3'>
                                ...
                                <div className="flex  w-auto space-x-1 lg:space-x-1 mt-2">
                                    <button>
                                        <svg className="text-black-500 w-3 h-auto fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                            ...
                            <div className='buttons mt-4 flex mb-5'>
